...
- **2d — THE ENGLISH HORN'S SEQUENCE NOTATION: THE PROTOTYPE — one of each thing, on the fixed scale, with the just marks** — `building` 2026-09-25 (Opus: 2d.1 · 2d.2 built — RUNNING_LOG §382 · §383) · `planned` 2026-09-25 (Fable, session 15, at his word *"Okay, go"*; RUNNING_LOG §368 … §380 — §368 the stats · §369 · §370 his sketch and his decisions · §371 the layout and the audit · §372 … §374 the scale · §375 · §376 one of each thing · §377 … §380 the pitch marks; COMPOSITION_NOTES LG-111 · LG-112; `docs/research/just_partials_notation.md` §1a) —
