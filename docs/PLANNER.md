...
**NOW ►** 2026-09-18 (session 2) — **0d ensemble balance: MEASURED, TRIMMED and HEARD** (RUNNING_LOG §44–§59). The 747-note run, the horn/trumpet knob (SI2 Dynamic Amount 0.70 → 1.00), **D13** (#5's mechanism unchanged — velocity the dynamic, CC7 shapes held notes, no flip to CC7), the trims on all 24 tracks under two anchors, and his ear on the velocity-64 chord: *"sounds good."* **Open in 0d: 0d.5 the velocity remap, and the percussion heard against the winds.** The bowed vibraphone is in (D12, its own lane).
